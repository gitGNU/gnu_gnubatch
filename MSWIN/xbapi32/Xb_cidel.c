/* Xb_cidel.c -- Delete command interpreter
...
extern int	xb_rmsg(const struct api_fd *, struct api_msg *),
		xb_wmsg(const struct api_fd *, struct api_msg *);
			
extern struct api_fd *xb_look_fd(const int);

int	xb_cidel(const int fd, const unsigned flags, const unsigned cinum)
{
	int		ret;
