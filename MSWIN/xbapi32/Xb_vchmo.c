/* Xb_vchmo.c -- Change variable permissions
...
int	xb_varchmod(const int fd, const unsigned flags, const slotno_t slotno, const Btmode *newmode)
{
	int	ret;
	...
	memset(&res, '\0', sizeof(res)); /* All this is a bit wasteful really but who cares */
	xb_mode_pack(&res.nm_mode, newmode);
