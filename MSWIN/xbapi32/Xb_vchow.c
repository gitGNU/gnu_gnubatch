/* Xb_vchow.c -- change variable owner
...
int	xb_varchown(const int fd, const unsigned flags, const slotno_t slotno, const char *newuser)
{
	int	ret;
