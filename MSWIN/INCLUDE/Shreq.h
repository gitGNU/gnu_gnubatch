...
#define	N_SYNCSINGLE	(NET_REQ|13)	/* Resync single job */
#define	N_RJASSIGN	(NET_REQ|15) 	/* Network message - given job remote assigns */
#define	N_CISEND	(NET_REQ|16) 	/* Network message - send command interpreter details */
...
#define	UNIXSIGHUP		1
#define	UNIXSIGINT      2
#define	UNIXSIGQUIT     3
#define	UNIXSIGKILL     9
#define	UNIXSIGBUS		10
#define	UNIXSIGSEGV		11
#define	UNIXSIGALRM		14
#define	UNIXSIGTERM     15
