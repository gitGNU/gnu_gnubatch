...
{
	IDC_TITLE,	IDH_132_395,	// Title Command Int Priority Load level: "" (Edit)
	IDC_CMDINTERP,	IDH_132_396,	// Title Command Int Priority Load level: "" (ComboBox)
	IDC_PRIORITY,	IDH_132_397,	// Title Command Int Priority Load level: "0" (Edit)
	IDC_SCR_PRIORITY,	IDH_132_397,	// Title Command Int Priority Load level: "Spin1" (msctls_updown32)
	IDC_LOADLEV,	IDH_132_399,	// Title Command Int Priority Load level: "0" (Edit)
	IDC_SCR_LOADLEV,	IDH_132_399,	// Title Command Int Priority Load level: "Spin2" (msctls_updown32)
	0, 0
};

BOOL CTitledlg::OnHelpInfo(HELPINFO* pHelpInfo) 
{
	return  do_contexthelp(pHelpInfo->iCtrlId, a132HelpIDs) ||
